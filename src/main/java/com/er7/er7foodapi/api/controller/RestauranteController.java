...
public class RestauranteController {
    ...
    public ResponseEntity<List<RestauranteModel>> listar() {
        List<RestauranteModel> restaurantesModels = restauranteModelAssembler.toCollectionModel(this.restauranteRepository.findAll());
        return ResponseEntity
            .ok()
            .header(HttpHeaders.ACCESS_CONTROL_ALLOW_ORIGIN, "http://192.168.1.5:8000")
            .body(restaurantesModels);
    }
